...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminsertar")) {
  ...
  $updateSQL = sprintf("UPDATE tblzona SET strNombre=%s, intEstado=%s WHERE idZona=%s",
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                  <form action="zona-edit.php" method="post" id="forminsertar" name="forminsertar" role="form">
                                       
                                       
                                        <div class="form-group">
                                            <label>Nombre de la Zona</label>
                                            <input class="form-control" placeholder="Escribir Nombre de la zona" name="strNombre" id="strNombre" value="<?php echo $row_DatosConsulta["strNombre"];?>">
                                        </div>
