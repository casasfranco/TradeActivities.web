...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminsertar")) {
  ...
  $insertSQL = sprintf("INSERT INTO tblzona(strNombre, intEstado, refPadre) VALUES (%s, %s, %s)",
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                  <form action="zona-add.php" method="post" id="forminsertar" name="forminsertar" role="form" >
                                        <div class="form-group">
                                            <label>Nombre de la Zona</label>
                                            <input class="form-control" placeholder="Escribir Nombre de la Zona" name="strNombre" id="strNombre">
                                        </div>
