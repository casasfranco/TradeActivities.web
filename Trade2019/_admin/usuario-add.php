                                ...
                                <div class="col-lg-6">
                                  <form action="usuario-add.php" method="post" id="forminsertar" name="forminsertar" role="form" onSubmit="javascript:return validarusuarioalta();">
                                    <div class="form-group">
                                      <label>E-mail</label>
                                        <input class="form-control" placeholder="email" name="strEmail" id="strEmail">
                                      </div>
...
$nombrecarpetadestino="../images/usuarios/";
...
$limiteancho="1200"; // En píxels, "0" significa cualquier tamaño permitido
$limitealto="1200"; // En píxels, "0" significa cualquier tamaño permitido
