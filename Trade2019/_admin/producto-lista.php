...
<body>
  ...
  <div id="page-wrapper">
     <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Gestión de Producto</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
?>">
	...
	<select name="intEstado" class="form-control" id="intEstado">
				...
				<option value="0" <?php if ((isset($_GET["intEstado"])) && (($_GET["intEstado"]=="0"))) echo "selected"; ?>>0: Inactivo</option>
				<option value="1" <?php if ((isset($_GET["intEstado"])) && (($_GET["intEstado"]=="1"))) echo "selected"; ?>>1: Activo </option>
			</select>
			</div>
				<div class="col-lg-2">
		...
		//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
			 ...
			 do { 
				...
				<tr>
					...
					<td>
						<a title="Editar Producto" href="producto-edit.php?id=<?php echo $row_DatosConsulta["idProducto"];?>" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a>
						
						<a title="Editar Opciones" href="productoopcion-edit.php?id=<?php echo $row_DatosConsulta["idProducto"];?>" class="btn btn-warning btn-circle"><i class="fa  fa-circle-o"></i></a>
						
						<a title="Editar Caracteristicas" href="productocaracteristica-edit.php?id=<?php echo $row_DatosConsulta["idProducto"];?>" class="btn btn-warning btn-circle"><i class="fa  fa-road"></i></a>
