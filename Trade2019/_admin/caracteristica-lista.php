...
<div class="row">
	<div class="col-lg-5">
		<a href="caracteristica-add.php" class="btn btn-outline btn-primary">Añadir Característica</a><br>
<br>
		...
		//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
			 ...
			 do { 
				...
				<td><?php echo $row_DatosConsulta["idCaracteristica"];?></td>
					...
					<td><a href="caracteristica-edit.php?id=<?php echo $row_DatosConsulta["idCaracteristica"];?>" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a> <a href="caracteristicadetalle-add.php?id=<?php echo $row_DatosConsulta["idCaracteristica"];?>" class="btn btn-success btn-circle"><i class="fa fa-plus"></i></a>	</td>
				</tr>
              		
              		<?php
				 caracteristicaniveladministracion($row_DatosConsulta["idCaracteristica"], "---- ");
