...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminsertar")) {
  ...
  $insertSQL = sprintf("INSERT INTO tblzona(strNombre, intEstado, refPadre, dblInferior, dblSuperior, dblCoste ) VALUES (%s, %s, %s, %s, %s, %s)",
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                  <form action="zonadetalle-add.php" method="post" id="forminsertar" name="forminsertar" role="form" >
                                        <div class="form-group">
                                          ...
                                          <div class="alert alert-danger oculto" id="errornombre">Nombre obligatorio</div>
                                            ...
                                            <label>Peso Inferior (kg)</label>
									  		...
									  		<div class="form-group">
                                            	<label>Coste</label>
                                            	<input class="form-control" value="0" name="dblCoste" id="dblCoste">
                                        	</div>
