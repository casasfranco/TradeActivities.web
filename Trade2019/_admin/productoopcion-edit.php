...
$consultaextendida="";
	...
	$query_DatosConsulta = "SELECT * FROM tblopcion WHERE (".$extramodelo.") AND refPadre=0 AND intEstado=1 ".$consultaextendida.$cadenaOrden;
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
     <div class="row">
           ...
           <a href="opcion-lista.php" class="btn btn-outline btn-info">Volver atrás</a><br><br>
			 ...
			 do { 
				...
				<tr>
					...
					<td><?php echo $row_DatosConsulta["strNombre"];?></td>
						...
						<td><?php echo MostrarOpcionProductoEdit($row_DatosConsulta["idOpcion"], $_GET["id"] );?></td>
