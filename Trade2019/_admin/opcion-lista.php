...
<div class="row">
	<div class="col-lg-5">
		<a href="opcion-add.php" class="btn btn-outline btn-primary">Añadir Opción</a><br>
<br>
			 ...
			 do { 
				...
				<td><?php echo $row_DatosConsulta["idOpcion"];?></td>
					...
					<td><strong><?php echo $row_DatosConsulta["strNombre"];?></strong></td>
						...
						<td></td>
					<td>
						<a href="opcion-edit.php?id=<?php echo $row_DatosConsulta["idOpcion"];?>" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a> <a href="opciondetalle-add.php?id=<?php echo $row_DatosConsulta["idOpcion"];?>" class="btn btn-success btn-circle"><i class="fa fa-plus "></i></a>
					</td>
				</tr>
              		
              		<?php
				 opcionniveladministracion($row_DatosConsulta["idOpcion"], "---- ");
