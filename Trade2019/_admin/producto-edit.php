...
if (comprobarseounico($_POST["idProducto"], $_POST["strSEO"]))
	{	
  ...
  $updateSQL = sprintf("UPDATE tblproducto SET strNombre=%s, strSEO=%s, refCategoria1=%s,  refCategoria2=%s,  refCategoria3=%s, refCategoria4=%s, refCategoria5=%s,  strImagen1=%s, strImagen2=%s, strImagen3=%s, strImagen4=%s, strImagen5=%s, strDescripcion=%s, dblPrecio=%s, dblPrecioAnterior=%s , intEstado=%s, refMarca=%s, intPrincipal=%s, intStock=%s, refImpuesto=%s, dblPeso=%s WHERE idProducto=%s",
					   ...
					   GetSQLValueString(ProcesarComaPrecio($_POST["dblPeso"]), "double"),
...
$query_DatosProducto = sprintf("SELECT * FROM tblproducto WHERE idProducto=%s", 
                            ...
                            <form action="producto-edit.php" method="post" id="forminsertar" name="forminsertar" role="form"><div class="row">
                                <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <label>Nombre</label>
                                            <input class="form-control" placeholder="Escribir Nombre del Producto" name="strNombre" id="strNombre" value="<?php echo $row_DatosProducto["strNombre"];?>" onChange="javascript:document.forminsertar.strSEO.value=CodificarSEO(document.forminsertar.strNombre.value);">
                                        </div>
                                          <div class="form-group">
                                            <label>SEO</label>
										...
										<div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Escribir el Precio Anterior" name="dblPrecioAnterior" id="dblPrecioAnterior" value="<?php echo $row_DatosProducto["dblPrecioAnterior"];?>">
                                        </div>
...
<div class="form-group">
		<label>Peso</label>
		<input class="form-control" placeholder="Escribir Peso" name="dblPeso" id="dblPeso" value="<?php echo $row_DatosProducto["dblPeso"];?>">
</div>
...
$tiposficheropermitidos="jpg, jpeg, png, bmp, PNG, JPG, BMP"; //  Por ejemplo "jpg,doc,png", separados por comas y poner "0" para permitir todos los tipos
$limiteancho="500"; // En píxels, "0" significa cualquier tamaño permitido
$limitealto="500"; // En píxels, "0" significa cualquier tamaño permitido
