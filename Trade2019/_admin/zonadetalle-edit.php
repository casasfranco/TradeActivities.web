...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminsertar")) {
  ...
  $updateSQL = sprintf("UPDATE  tblzona SET strNombre=%s, intEstado=%s, dblInferior=%s, dblSuperior=%s, dblCoste=%s WHERE idZona=%s",
                       GetSQLValueString($_POST["strNombre"], "text"),
					   GetSQLValueString($_POST["intEstado"], "int"),
					   GetSQLValueString(ProcesarComaPrecio($_POST["dblInferior"]), "double"),
					   GetSQLValueString(ProcesarComaPrecio($_POST["dblSuperior"]), "double"),
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
     <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Gestión de Áreas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>

            <a href="zona-lista.php" class="btn btn-outline btn-info">Volver atrás</a><br>
<br>
                                ...
                                <div class="col-lg-6">
                                  <form action="zonadetalle-edit.php" method="post" id="forminsertar" name="forminsertar" role="form">
                                        ...
                                        <div class="form-group">
									  	...
									  	<div class="form-group">
                                            <label>Peso Inferior (kg)</label>
                                            	<input class="form-control" value="<?php echo $row_DatosConsulta["dblInferior"];?>" name="dblInferior" id="dblInferior">
                                        		</div>
									      	<div class="form-group">
                                            	<label>Peso Superior (kg)</label>
                                            	<input class="form-control" value="<?php echo $row_DatosConsulta["dblSuperior"];?>" name="dblSuperior" id="dblSuperior">
                                        	</div>
									  		<div class="form-group">
                                            	<label>Coste</label>
                                            	<input class="form-control" value="<?php echo $row_DatosConsulta["dblCoste"];?>" name="dblCoste" id="dblCoste">
                                        	</div>
