...
<div id="wrapper">
  ...
  <div id="page-wrapper">
     <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Gestión de Caracteristica</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                  <form action="caracteristicadetalle-add.php" method="post" id="forminsertar" name="forminsertar" role="form" >
                                        <div class="form-group">
                                            <label>Nombre de la Caracteristica</label>
                                            <input class="form-control" placeholder="Escribir Nombre de la Caracteristica" name="strNombre" id="strNombre">
                                        </div>
