                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                  <form action="marca-edit.php" method="post" id="forminsertar" role="form" name="forminsertar">
                                        
                                        
                                        <div class="form-group">
                                            <label>Nombre de la Marca</label>
                                            <input class="form-control" placeholder="Escribir Nombre del usuario" name="strMarca" id="strMarca" value="<?php echo $row_DatosConsulta["strMarca"];?>">
                                        </div>
									  <div class="form-group">
