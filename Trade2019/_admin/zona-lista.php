...
<div class="row">
	<div class="col-lg-5">
		<a href="zona-add.php" class="btn btn-outline btn-primary">Añadir Zona</a><br>
<br>
		...
		//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
			 ...
			 do { 
				...
				<td><?php echo $row_DatosConsulta["idZona"];?></td>
					...
					<td></td>
					<td>
						<a href="zona-edit.php?id=<?php echo $row_DatosConsulta["idZona"];?>" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a> <a href="zonadetalle-add.php?id=<?php echo $row_DatosConsulta["idZona"];?>" class="btn btn-success btn-circle"><i class="fa fa-plus "></i></a>
					</td>
				</tr>
              		
              		<?php
				zonaniveladministracion($row_DatosConsulta["idZona"], "---- ");
