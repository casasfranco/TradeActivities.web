...
if (isset($_GET["valor"]))
{
	switch ($_GET["valor"]) {
    case 1:
        $parametro_orden= "idImpuesto";
        break;
    case 2:
        $parametro_orden= "strNombre";
        break;
    case 3:
        $parametro_orden= "dblImpuesto";
        break;
	}
}
else
	$parametro_orden= "idImpuesto"; //POR DEFECTO
...
{
	$query_DatosConsulta = sprintf("SELECT * FROM tblimpuesto ".$cadenaOrden);
	}
...
<div class="row">
	<div class="col-lg-5">
		<a href="impuesto-add.php" class="btn btn-outline btn-primary">Añadir Impuesto</a><br>
<br>
...
<div class="row">
		...
		//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
			 ...
			 do { 
				...
				<tr>
						<td><?php echo $row_DatosConsulta["idImpuesto"];?></td>
						
					<td><?php echo $row_DatosConsulta["strNombre"];?></td>
						<td><?php echo $row_DatosConsulta["dblImpuesto"];?></td>
					
						
					<td><a href="impuesto-edit.php?id=<?php echo $row_DatosConsulta["idImpuesto"];?>" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a></td>
				</tr>
