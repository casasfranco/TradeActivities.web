...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminsertar")) {
  ...
  $updateSQL = sprintf("UPDATE tblopcion SET strNombre=%s, intEstado=%s, intOrden=%s, dblIncremento=%s WHERE idOpcion=%s",
					   ...
					   GetSQLValueString(ProcesarComaPrecio($_POST["dblIncremento"]), "double"),
                                ...
                                <div class="col-lg-6">
                                  <form action="opciondetalle-edit.php" method="post" id="forminsertar" name="forminsertar" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Escribir Nombre de la opcion" name="strNombre" id="strNombre" value="<?php echo $row_DatosConsulta["strNombre"];?>">
                                        </div>
                                          <div class="alert alert-danger oculto" id="errornombre">Nombre obligatorio</div>
                                          
                                          <div class="form-group">
                                            <label>Orden de opcion</label>
                                            <input class="form-control" placeholder="Escribir Orden de la opcion" name="intOrden" id="intOrden" value="<?php echo $row_DatosConsulta["intOrden"];?>">
                                        </div>
                                          <div class="alert alert-danger oculto" id="errororden">Orden obligatorio</div>   
									  <div class="form-group">
                                            <label>Incremento de opcion</label>
