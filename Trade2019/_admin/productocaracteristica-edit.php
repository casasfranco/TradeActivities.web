...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminsertar")) {
	...
	//SEGUNDO SELECCIONAMOS LAS CARACTERISTICAS
	...
	do {
		...
		{
			//INSERTO EN LA TABLA PRDDUCTOCARACTERISTICA
...
$consultaextendida="";
	...
	$query_DatosConsulta = "SELECT * FROM tblcaracteristica WHERE (".$extramodelo.") AND refPadre=0 AND intEstado=1 ".$consultaextendida.$cadenaOrden;
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
     <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Gestión de Características de Producto</h1>
                </div>
                <!-- /.col-lg-12 -->
            ...
            <a href="producto-lista.php" class="btn btn-outline btn-info">Volver atrás</a><br><br>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                               ...
                               <form action="productocaracteristica-edit.php" method="post" id="forminsertar" name="forminsertar" role="form">
			 ...
			 do { 
				...
				<tr>
					...
					<td><?php echo $row_DatosConsulta["strNombre"];?></td>
						...
						<td><?php echo MostrarCaracteristicaProductoEdit($row_DatosConsulta["idCaracteristica"], $_GET["id"] );?></td>
