...
if (isset($_POST['strEmail'])) {
  ...
  if (($loginFoundUser) && (mysqli_result($LoginRS,0,'intNivel')!=0)) {
    ...
    $_SESSION['tradeactivities_UserId'] = mysqli_result($LoginRS,0,'idUsuario');
    $_SESSION['tradeactivities_Mail'] = mysqli_result($LoginRS,0,'strEmail');
    $_SESSION['tradeactivities_Nivel'] = mysqli_result($LoginRS,0,'intNivel');
	  
	//ContabilizarAcceso($_SESSION['tradeactivities_UserId']);
