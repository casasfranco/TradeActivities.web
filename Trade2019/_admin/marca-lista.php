...
if (isset($_GET["valor"]))
{
	switch ($_GET["valor"]) {
    case 1:
        $parametro_orden= "idMarca";
        break;
    case 2:
        $parametro_orden= "strMarca";
        break;
    case 3:
	...
	$parametro_orden= "idMarca"; //POR DEFECTO
...
if ((isset($_GET["MM_Buscar"])) && ($_GET["MM_Buscar"]=="formbusqueda"))
{
	...
	$consultaextendidaparaordenacion="&MM_Buscar=formbusqueda&strBuscar=".$_GET["strBuscar"];
	...
	$query_DatosConsulta = "SELECT * FROM tblmarca WHERE (".$extramodelo.")  ".$consultaextendida.$cadenaOrden;
	//echo $query_DatosConsulta;
}
else
{
	$query_DatosConsulta = sprintf("SELECT * FROM tblmarca ".$cadenaOrden);
	}
...
<div class="row">
	<div class="col-lg-5">
		<a href="marca-add.php" class="btn btn-outline btn-primary">Añadir Marca</a>
	</div>
	<div class="col-lg-7">
	<div class="well">

	<form action="marca-lista.php" method="get" id="formbusqueda" name="formbusqueda" role="form">
...
<div class="row">
		...
		//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
			 ...
			 do { 
				...
				<tr>
						<td><?php echo $row_DatosConsulta["idMarca"];?></td>
						
					<td><?php echo $row_DatosConsulta["strMarca"];?></td>
						<td><?php echo $row_DatosConsulta["intOrden"];?></td>
						<td><?php echo MostrarEstado($row_DatosConsulta["intEstado"]);?></td>
						
					<td><a href="marca-edit.php?id=<?php echo $row_DatosConsulta["idMarca"];?>" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a></td>
				</tr>
