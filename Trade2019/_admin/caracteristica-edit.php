...
<div id="wrapper">
  ...
  <div id="page-wrapper">
     <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Gestión de Opcion</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>

            <a href="caracteristica-lista.php" class="btn btn-outline btn-info">Volver atrás</a><br>
<br>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                  <form action="caracteristica-edit.php" method="post" id="forminsertar" name="forminsertar" role="form">
                                       
                                       
                                        <div class="form-group">
                                            <label>Nombre de la Caracteristica</label>
                                            <input class="form-control" placeholder="Escribir Nombre de la Caracteristica" name="strNombre" id="strNombre" value="<?php echo $row_DatosConsulta["strNombre"];?>">
                                        </div>
                                          <div class="alert alert-danger oculto" id="errornombre">Nombre obligatorio</div>
                                          
                                          <div class="form-group">
                                            <label>Orden de opcion</label>
                                            <input class="form-control" placeholder="Escribir Orden de la Caracteristica" name="intOrden" id="intOrden" value="<?php echo $row_DatosConsulta["intOrden"];?>">
                                        </div>
