...
$query_DatosConsultaTotales = sprintf("SELECT COUNT(idProducto) AS TotalProductosConsulta FROM tblproducto WHERE intEstado=1 AND (refCategoria1=".$categoriaparaver." OR
refCategoria2=".$categoriaparaver." OR
refCategoria3=".$categoriaparaver." OR
refCategoria4=".$categoriaparaver." OR
refCategoria5=".$categoriaparaver." ) ORDER BY idProducto ASC");
...
$query_DatosConsulta = sprintf("SELECT idProducto FROM tblproducto WHERE intEstado=1 AND (refCategoria1=".$categoriaparaver." OR
refCategoria2=".$categoriaparaver." OR
refCategoria3=".$categoriaparaver." OR
refCategoria4=".$categoriaparaver." OR
refCategoria5=".$categoriaparaver." ) ORDER BY idProducto ASC LIMIT 0,".$resultadosporclick);
  ...
  <div class="container">
	...
	<div class="col-sm-3">
	 ...
	 <?php if(isset($_GET["id"]) && !empty($_GET["id"])){
		   MostrarBreadcrumbs($categoriaparaver);
		  }?> 
		  ...
		  <div class="breadcrumbs">
				<ol class="breadcrumb">
				  <li><a href="index.php">Inicio</a></li>
					<?php echo'<li>'.MostrarMarca($_GET["marca"]).'</li>';
					?>
...
$(document).ready(function(){
    $(document).on('click','.show_more',function(){
        ...
        $.ajax({
			...
			<?php if(isset($_GET["marca"]) && !empty($_GET["marca"])){?>	
			data:'id='+ID+'&max=<?php echo $resultadosporclick;?>'+'&marca=<?php echo $_GET["marca"];?>',
			<?php }?>
