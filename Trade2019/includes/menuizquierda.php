...
<?php if (_marcas==1){?>
			...
			do { 
				?>
									<li><a href="categoria.php?marca=<?php echo $row_DatosConsultaMarcas["idMarca"]?>"> <span class="pull-right">(<?php echo ProductosporMarca($row_DatosConsultaMarcas["idMarca"]);?>)</span><?php echo $row_DatosConsultaMarcas["strMarca"];?></a></li>
